...
* [Airflow DAGs](#airflow-dags)
    * [DAG: validate.py - MTR file quality check](#dag-validatepy---mtr-file-quality-check)
    * [DAG: load_to_clickhouse.py](#dag-load_to_clickhousepy)
...
* [Gold Layer](#gold-layer)
    ...
    * [Schema - models/gold/schema.yml](#schema---models-gold-schemayml)
...
* [Orchestration – Airflow + dbt](#orchestration–--airflow-dbt)
    ...
    * [DAG Schedule and Configuration](#dag-schedule-and-configuration)
        * [Workflow Diagram dbt_run_gold --> dbt_test_gold](#workflow-diagram-dbt_run_gold---dbt_test_gold)
